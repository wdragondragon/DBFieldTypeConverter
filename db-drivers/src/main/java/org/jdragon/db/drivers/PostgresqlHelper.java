...
public class PostgresqlHelper extends DriverHelper {

    public PostgresqlHelper(String address, String database, String username, String password, Map<String, String> otherParameter) {
